...
public class AnimationLoaderReeti {
    ...
    public AnimationReeti loadAnimation(Stickman sm, String name, int duration, boolean block,  HashMap<String, String> extraParams){
    ...
    public AnimationReeti loadAnimation(Stickman sm, String name, int duration, boolean block) {
        AnimationReeti a = null;
    ...
    public EventAnimationReeti loadEventAnimation(Stickman sm, String name, int duration, boolean block) {
