	...
	public void createShape() {
		...
		case SMILEEND:
			...
			if (movement <= 1) {
				...
				gp.moveTo(mStart.x - mLength / 2 - movement / 3 * 2, mStart.y - movement / 2);
				gp.quadTo(mStart.x, mStart.y + 1 + movement / 3 * 2, mEnd.x + movement / 3 * 2,
						mStart.y - movement / 2);
			}
			break;
		...
		case EMBARRASSED:
			...
			gp.quadTo((mStart.x - mLength / 2 + mEnd.x + movement / 10 * 3) / 2, mStart.y + 1,
					mEnd.x + movement / 10 * 3, mEnd.y + movement / 20);
			break;
