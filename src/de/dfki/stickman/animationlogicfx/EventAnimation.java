...
public class EventAnimation extends Animation {
	...
	public EventAnimation(StickmanFX sm, int duration, boolean block) {
	...
	public void playEventAnimationPart() {
		mAnimator = new Animator(mStickmanFX, this, mAnimationPart, mWTS);
	...
	public void writeXML(IOSIndentWriter out) throws XMLWriteError {
		out.println("<StickmanEventAnimation stickmanname = \"" + mStickmanFXName + "\" name=\"" + mName + "\" id=\"" + mID + "\" duration=\"" + mDuration + "\" blocking=\"" + mBlocking + "\">").push();
		if (mParameter != null) {
	...
	public void parseXML(final Element element) throws XMLParseError {
		...
		mStickmanFXName = element.getAttribute("stickmanname");
