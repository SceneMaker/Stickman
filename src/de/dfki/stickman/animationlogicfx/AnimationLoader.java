...
public class AnimationLoader {
    ...
    private final static String sANIMATIONPATH = "de.dfki.stickman";
    private static final Set<String> sAnimationSubPackages = new HashSet<>(Arrays.asList("head", "faceFX", "gesture", "environment"));
    ...
    public Animation loadAnimationfx(StickmanFX sm, String name, int duration, boolean block) {
        Animation a = null;
    ...
    public EventAnimation loadEventAnimation(StickmanFX sm, String name, int duration, boolean block) {
