...
public class AngrySmallMouth extends AnimationFX {
	...
	public void playAnimation() {
		...
		mAnimationPartFX.add(new AnimationContentFX(mStickmanFX.mFaceWrinkleFX, "shape", "ANGRY")); /// Add
																									/// by
																									/// Robbie
		...
		mAnimationPartFX.add(new AnimationContentFX(mStickmanFX.mFaceWrinkleFX, "shape", "ANGRYEND")); /// Add
																										/// by
																										/// Robbie
