 ...
 *
 */
public class FemaleHair extends BodyPart {

	public static enum SHAPE {
		DEFAULT, FADEIN, FADEOUT
	};

	public FemaleHair.SHAPE mShape = FemaleHair.SHAPE.DEFAULT;
	...
	public FemaleHair(Stickman3D sm) {
		mStickmanFX = sm;
	...
	public void resetShape() {
		mShape = FemaleHair.SHAPE.DEFAULT;
	}
