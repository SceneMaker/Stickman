...
public class RightForeLeg extends BodyPart {
	...
	public RightForeLeg.SHAPE mShape = RightForeLeg.SHAPE.DEFAULT;

	RightUpperLeg mUpperLegFX;
	int mLegLength = 90;
	...
	public RightForeLeg(RightUpperLeg rightUpperLegFX) {
	...
	public void resetShape() {
		mShape = RightForeLeg.SHAPE.DEFAULT;
	}
