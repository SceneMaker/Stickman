...
public class LeftFoot extends BodyPart {
	...
	public LeftFoot.SHAPE mShape = LeftFoot.SHAPE.DEFAULT;

	LeftForeLeg mLeftForeLegFX;

	public MeshView mLeftFootMeshView;
	...
	public LeftFoot(LeftForeLeg leftForeLeg) {
		...
		mLength = 20;
		if (mLeftForeLegFX.mUpperLegFX.mDownBody.mUpperBody.mNeckFX.mHeadFX.mStickmanFX.mType == Stickman3D.TYPE.MALE)
