 ...
 *
 */
public class RightWrist extends BodyPart {
	...
	public RightWrist(RightForeArm rightForeArmFX) {
	...
	private void activateConfigColor() {
		String stickmanName = mRightForeArmFX.mUpperArmFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.mName;
	...
	public void calculate(int step) {
		...
		if (mRightForeArmFX.mUpperArmFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.mType == Stickman3D.TYPE.MALE) {
