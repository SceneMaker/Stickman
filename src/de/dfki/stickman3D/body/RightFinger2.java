 ...
 *
 */
public class RightFinger2 extends BodyPart {
	...
	public void update() {
		...
		// draw outlines
		// if
		// (mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.setCharacterInvisible
		// == false) {
		...
		// == true) {
		// if
		// (mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.fadeControler
		// == true) //Added by Robbie
		// {
		// int fadeFactor =
		...
		// mColor.getBlue(), (fadeFactor * 100 / 255) / 100f);
