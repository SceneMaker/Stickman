...
public class UpperBodyAndHead extends BodyPartFX {
	...
	public void calculate(int step) {
		rx = new Rotate(mXRotation, 65, mYTranslation + 280, -105, Rotate.X_AXIS);
		ry = new Rotate(mYRotation, 65, mYTranslation + 280, -105, Rotate.Y_AXIS);
		rz = new Rotate(mZRotation, 65, mYTranslation + 280, -105, Rotate.Z_AXIS);
