...
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mBombeFX, "shape", "BOMBETRANSITION"));
//        playAnimationPart(mDuration);
//        
//     // headTilt
//        mAnimationPartFX = new ArrayList<>();
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mRightEyeFX, "tilt", translationUnit));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mRightEyebrowFX, "tilt", translationUnit));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftEyeFX, "tilt", translationUnit));
...
//        
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mMouthFX, "tilt", translationUnit));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mFaceWrinkleFX, "tilt", translationUnit));
//        
//     // embarrassed
...
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mFaceWrinkleFX, "shape", "EMBARRASSED"));   ///Add by Robbie
...
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mFaceWrinkleFX, "shape", "EMBARRASSEDEND"));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mFaceWrinkleFX, "shape", "SURPRISED"));
//        playAnimationPart(mDuration);
//        
//        pauseAnimation(1000);
//        
...
//        
//        mAnimationPartFX = new ArrayList<>();
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftUpperLegFX, "rotate", -rotationUnit * 5));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftForeLegFX, "rotate", rotationUnit*2));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftFootFX, "rotate", rotationUnit*3));
//        playAnimationPart(mDuration);
//        
//        for(int i = 0; i<3; i++)
//        {
//        	mAnimationPartFX = new ArrayList<>();
//        	mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftForeLegFX, "rotate", -rotationUnit));
//        	mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftFootFX, "rotate", -rotationUnit*3));
...
//        
//        mAnimationPartFX = new ArrayList<>();
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mBombeFX, "shape", "BOMBEEXPLOSION"));
//        playAnimationPart(mDuration);
//        
...
//        
//        mAnimationPartFX = new ArrayList<>();
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mBombeFX, "shape", "DEFAULT"));
...
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mRightForeLegFX, "translate", 100));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftForeLegFX, "rotate", 70));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftForeLegFX, "translate", 120));
//        playAnimationPart(100);
//        
//        mAnimationPartFX = new ArrayList<>();
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mRightUpperLegFX, "rotate", 90));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mRightUpperLegFX, "translate", 155));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftUpperLegFX, "rotate", 120));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftUpperLegFX, "translate", 160));
//        playAnimationPart(100);
//        
//        mAnimationPartFX = new ArrayList<>();
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mLeftEyeFX, "rotate", 90));
//        mAnimationPartFX.add(new AnimationContent3D(mStickmanFX.mRightEyeFX, "rotate", 170));
//        playAnimationPart(100);
//        
