 ...
 *
 */
public class Working extends Animation {
	public Working() {
	...
	public void playAnimation() {
		...
		if (mStickmanFX.mType == Stickman3D.TYPE.FEMALE)
			mAnimationPartFX.add(new AnimationContent(mStickmanFX.mUpperBodyAndHand, "ytranslate", 60));
		else
		...
		if (mStickmanFX.mType == Stickman3D.TYPE.FEMALE)
			mAnimationPartFX.add(new AnimationContent(mStickmanFX.mLeftForeArmFX, "rotate", -88)); // <--
		else
		...
		mAnimationPartFX.add(new AnimationContent(mStickmanFX.mLeftWrist, "yrotate", 50));
